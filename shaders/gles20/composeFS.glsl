...
vec4 calcShadow(vec2 uv, vec2 offset) {
    ...
    color += texture2D(uShadowTex, uv) * 0.1964825501511404;
    color += texture2D(uShadowTex, uv + (off1 )) * 0.2969069646728344;
    color += texture2D(uShadowTex, uv - (off1)) * 0.2969069646728344;
    color += texture2D(uShadowTex, uv + (off2 )) * 0.09447039785044732;
    color += texture2D(uShadowTex, uv - (off2 )) * 0.09447039785044732;
    color += texture2D(uShadowTex, uv + (off3 )) * 0.010381362401148057;
    color += texture2D(uShadowTex, uv - (off3 )) * 0.010381362401148057;
    return color;
}
