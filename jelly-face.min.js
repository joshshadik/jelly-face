...
modelIndex=0;
function start(){loadingElement=document.getElementById("loadingText");canvas=document.getElementById("glcanvas");canvas.width=window.innerWidth;canvas.height=window.innerHeight;initWebGL(canvas);if(gl){gl.clearColor(0,0,0,1);gl.clearDepth(1);gl.enable(gl.DEPTH_TEST);gl.depthFunc(gl.LEQUAL);gl.enable(gl.CULL_FACE);gl.cullFace(gl.BACK);gl.disable(gl.BLEND);_time=new Time;var a="./shaders/gles20";_supportsWebGL2&&(a="./shaders/gles30");shaders=new ShaderLoader(a,"./shaders/util");shaders.load("composeFS","compose",
